...
namespace Emlak
{
    public partial class Kayit : Form
    {
        ...
        private void KullaniciEkleme(string yetkiDurumu)
        {
            ...
            {
                Kullanici kullanici = dbEmlakEntity.Kullanicis.FirstOrDefault(x => x.kullaniciAd == kullanici_adi.Text);
                if (kullanici != null)
                {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            kullaniciAd = kullanici_adi.Text,
                            kullaniciSifre = kullanici_sifre.Text,
                            yetki = yetkiDurumu
                        };
                        ...
                        kullanici_adi.Text = ""; kullanici_sifre.Text = "";
                    }
                    catch (Exception e)
                    {
        ...
        private void checkBox_yetkilendirme_CheckedChanged(object sender, EventArgs e)
        {
